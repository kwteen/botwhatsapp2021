...
// FUNCTION
      ...
      if (chats == 'Bodoh'){
        ...
        const cegan = [
            "https://i.ibb.co/7GVgzd6/Aka5hiro.jpg",
            "https://i.ibb.co/vYQ3p7y/Aka-Shiro22.jpg",
            "https://i.ibb.co/ysnNT18/bilyard.jpg",
            "https://i.ibb.co/sWLNVkW/bilyard1.jpg",
            "https://i.ibb.co/GnDg5tT/arrow.jpg",
            "https://i.ibb.co/tphs9fF/arrow1.jpg"
        ]
        const cecan = [
            {
	...
	// Filter Banned People
        ...
        case 'tnc':
            ...
            break
        case 'help':
            const bots = `Hi minna, this is AkaShiro Bot, to find out the commands menu, type *${prefix}menu* , *${prefix}p*`
            ...
            if (isOwnerB) {
                await aruga.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await aruga.sendText(chekgrup.id, `what up y'all , I'm AkaShiro Bot. To find out the commands on this Bot type ${prefix}menu`)
                      })
            } else {
	...
	if (!isBotGroupAdmins) return aruga.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
        ...
        case 'ytmp3':
            ...
            case 'distance':
                ...
                break
                case 'glitch':
                    if (args.length === 0) return aruga.reply(from, `Kirim perintah *${prefix}glitch [ |Teks1|Teks2 ]*, contoh *${prefix}glitch |BOT|Dev AkaShiro*`, id)
                    argz = body.trim().split('|')
                    if (argz.length >= 2) {
                        aruga.reply(from, mess.wait, id)
                        ...
                        await aruga.reply(from, `Wrong Format!\n[❗] Kirim perintah *${prefix}glitch [ |Teks1|Teks2 ]*, contoh *${prefix}glitch |BOT|Dev AkaShiro*`, id)
                    }
                    break
					case 'javcosplay':
					await aruga.reply(from, mess.wait, id)
                            ...
                            case 'asupan':
                                ...
                                rugaapi.asupan()
                                    .then(async (body) => {
                                        ...
                                        await aruga.sendFileFromUrl(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, 'asupan.mp4', 'Follow IG: https://www.instagram.com/akashiro23 untuk mendapatkan asupan lebih banyak.', id)
...
_Desc di update oleh : @${chat.groupMetadata.descOwner.replace('@c.us','')} pada *${moment(chat.groupMetadata.descTime * 1000).format('dddd, DD MMMM YYYY')}* pukul ${moment(chat.groupMetadata.descTime * 1000).format('HH:mm:ss')}_`)
                    ...
                    case 'screen': {
                        ...
                        case 'listbacot':
                            ...
                            bacotanmu += '╚═〘 *A K A S H I R O  B O T* 〙'
			...
			break
                ...
                case 'santet': //work
                    ...
                    case 'aiquote' :
                            ...
                            await aruga.sendFileFromUrl(from, aiquote.data, 'quote.jpg', 'FOLLOW NGAB \ :V https://www.instagram.com/akashiro23/' , id )
                        break
                case 'ttp':
